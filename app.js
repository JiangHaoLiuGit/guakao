    ...
    if(token.access_token){
      ...
      ajax.post(wx.getStorageSync("config").openId_url,{
        ...
        if(zhi == 1007){
          ...
          wx.showToast({ title: "用户无效.请联系管理员" ,icon: "none",duration: 2000 });
          ...
          if(res.data.userRole == "enterprise"){
            wx.navigateTo({
              url: "/pages/user/index/index?zhi="+zhi,
            });
          }else{
              ...
              wx.request({
                ...
                success(res) {
                  ...
                  if(res.code == "-9004"){
                    ...
                    if(res.data.data.userRole == "enterprise"){
                    ...
                    // wx.showToast({ title: "获取用户信息失败" ,icon: "none",duration: 2000 });
                  }
                },
                fail(error) {
                    //失败结果
