  ...
  onLoad: function (options) {
    ...
    if(options.id){
      ...
      ajax.get(wx.getStorageSync("config").getCompanyListId_url,{
        ...
        console.log(res)
        res.data.driverValidityStart = this.formatTimeTwo(res.data.driverValidityStart)
        res.data.driverValidityEnd = this.formatTimeTwo(res.data.driverValidityEnd)
        res.data.updateDate = this.formatTimeThree(res.data.updateDate)
        res.data.drivingModel = this.data.carModel[res.data.drivingModel]
